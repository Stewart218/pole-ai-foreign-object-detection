...
class AugmentConfig:
    ...
    source_image_dir = Path(
        r"E:\Pole_AI_Project\data\yolo_dataset\images\train"
    )


    source_label_dir = Path(
        r"E:\Pole_AI_Project\data\yolo_dataset\labels\train"
    )
    ...
    output_image_dir = Path(
        r"E:\Pole_AI_Project\data\augmented_dataset\images\train"
    )


    output_label_dir = Path(
        r"E:\Pole_AI_Project\data\augmented_dataset\labels\train"
    )
...
def generate_report(statistics):
    ...
    report_path=Path(
        ...
        r"E:\Pole_AI_Project\data\augmented_dataset\augmentation_report.txt"
